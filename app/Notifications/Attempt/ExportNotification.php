...
namespace App\Notifications\Attempt;

use Maatwebsite\Excel\Facades\Excel;
use App\Exports\AttemptsExports;
...
class ExportNotification extends Notification
{
    ...
    private function createExport()
    {
        ...
        Excel::store(new AttemptsExports($this->data), $this->path, config('app.export_disk', 's3'));
    ...
    private function getSubject()
    {
        ...
        return env('APP_NAME') . ' | Attempt export notification';
