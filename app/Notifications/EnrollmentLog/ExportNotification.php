...
namespace App\Notifications\EnrollmentLog;

use Maatwebsite\Excel\Facades\Excel;
use App\Exports\EnrollmentLogsExports;
...
class ExportNotification extends Notification
{
    ...
    private function createExport()
    {
        ...
        Excel::store(new EnrollmentLogsExports($this->data), $this->path, config('app.export_disk', 's3'));
    ...
    private function getSubject()
    {
        ...
        return env('APP_NAME') . ' | EnrollmentLog export notification';
