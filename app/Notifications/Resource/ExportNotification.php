...
use App\Exports\ResourcesExports;
...
class ExportNotification extends Notification
{
    ...
    private function createExport()
    {
        ...
        Excel::store(new ResourcesExports($this->data), $this->path, config('app.export_disk', 's3'));
    ...
    private function getSubject()
    {
        ...
        return env('APP_NAME') . ' | Resource export notification';
