...
namespace App\Notifications\Path;

use Maatwebsite\Excel\Facades\Excel;
use App\Exports\PathsExports;
...
class ExportNotification extends Notification
{
    ...
    private function createExport()
    {
        ...
        Excel::store(new PathsExports($this->data), $this->path, config('app.export_disk', 's3'));
    ...
    private function getSubject()
    {
        ...
        return env('APP_NAME') . ' | Path export notification';
