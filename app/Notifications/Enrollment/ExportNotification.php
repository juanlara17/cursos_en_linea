...
use App\Exports\EnrollmentsExports;
...
class ExportNotification extends Notification
{
    ...
    private function createExport()
    {
        ...
        Excel::store(new EnrollmentsExports($this->data), $this->path, config('app.export_disk', 's3'));
    ...
    private function getSubject()
    {
        ...
        return env('APP_NAME') . ' | Enrollment export notification';
