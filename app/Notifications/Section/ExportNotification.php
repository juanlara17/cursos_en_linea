...
namespace App\Notifications\Section;

use Maatwebsite\Excel\Facades\Excel;
use App\Exports\SectionsExports;
...
class ExportNotification extends Notification
{
    ...
    private function createExport()
    {
        ...
        Excel::store(new SectionsExports($this->data), $this->path, config('app.export_disk', 's3'));
    ...
    private function getSubject()
    {
        ...
        return env('APP_NAME') . ' | Section export notification';
