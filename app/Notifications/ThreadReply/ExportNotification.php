...
namespace App\Notifications\ThreadReply;

use Maatwebsite\Excel\Facades\Excel;
use App\Exports\ThreadRepliesExports;
...
class ExportNotification extends Notification
{
    ...
    private function createExport()
    {
        ...
        Excel::store(new ThreadRepliesExports($this->data), $this->path, config('app.export_disk', 's3'));
    ...
    private function getSubject()
    {
        ...
        return env('APP_NAME') . ' | ThreadReply export notification';
