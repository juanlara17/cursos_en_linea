...
namespace App\Notifications\ForumSubscription;

use Maatwebsite\Excel\Facades\Excel;
use App\Exports\ForumSubscriptionsExports;
...
class ExportNotification extends Notification
{
    ...
    private function createExport()
    {
        ...
        Excel::store(new ForumSubscriptionsExports($this->data), $this->path, config('app.export_disk', 's3'));
    ...
    private function getSubject()
    {
        ...
        return env('APP_NAME') . ' | ForumSubscription export notification';
