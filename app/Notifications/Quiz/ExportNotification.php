...
namespace App\Notifications\Quiz;

use Maatwebsite\Excel\Facades\Excel;
use App\Exports\QuizzesExports;
...
class ExportNotification extends Notification
{
    ...
    private function createExport()
    {
        ...
        Excel::store(new QuizzesExports($this->data), $this->path, config('app.export_disk', 's3'));
    ...
    private function getSubject()
    {
        ...
        return env('APP_NAME') . ' | Quiz export notification';
