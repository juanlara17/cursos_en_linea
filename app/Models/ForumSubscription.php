...
class ForumSubscription extends Model
{
    ...
    protected $fillable = ['status', 'user_id', 'subscriptionable_id', 'subscriptionable_type'];

    protected $creatable = ['status', 'user_id', 'subscriptionable_id', 'subscriptionable_type'];
