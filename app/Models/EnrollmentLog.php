...
class EnrollmentLog extends Model
{
    ...
    protected $fillable = ['type', 'dedication', 'enrollment_id', 'lesson_id'];

    protected $creatable = ['type', 'dedication', 'enrollment_id', 'lesson_id'];

    protected $updatable = ['type', 'dedication'];
